    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(20, MENU_OPTION[i], COLOR_YELLOW, text_center_pos=((WIN_WIDTH / 2), 200 + 30 * i))
                else:
                    self.menu_text(20, MENU_OPTION[i], COLOR_WHITE,text_center_pos=((WIN_WIDTH / 2), 200 + 30 * i))
            pygame.display.flip()
